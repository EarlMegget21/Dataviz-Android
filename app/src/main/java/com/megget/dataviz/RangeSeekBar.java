...
public class RangeSeekBar<T extends Number> extends AppCompatImageView {
    ...
    private static final int DEFAULT_TEXT_SIZE_IN_DP = 0;//14;
    private static final int DEFAULT_TEXT_DISTANCE_TO_BUTTON_IN_DP = 0;//8;
    private static final int DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP = 0;//8;
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        //pour mettre à jour l'affichage des dates
        min.setText(Integer.toString((Integer)getSelectedMinValue()));
        max.setText(Integer.toString((Integer)getSelectedMaxValue()));
    }
    ...
    public void setMinTextView(TextView m){
        min=m;
    }

    public void setMaxTextView(TextView m){
        max=m;
    }
